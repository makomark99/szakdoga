  ...
  <nav class=" navbar navbar-expand-md navbar-dark bg-dark mb-5 sticky-top ">
    <div class="container-fluid nav-tabs  ">
      ...
      <ul class="navbar-nav ms-auto mb-0 mb-md-0 ">
        <li class="nav-item ">
          <a class="navbar-brand " data-bs-placement="bottom" data-bs-toggle="tooltip" data-bs-placement="bottom"
            title="Logo" href="index.php"><img id="logo" src="img\mkc_logo.png" alt="Logo"></a>
        </li>
      </ul>
          ...
          <?php
            if (isset($_SESSION["useruid"])) {
              ...
              src="img\clothes.svg" alt="Felszerelések"></a>
                ...
                echo '<li class="nav-item ">
              <a class="nav-link text-light" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Profil" href="profil.php"><img 
              src="img\person-square.svg" alt="Profil" ></a>
            </li>';
                if ($sadmin) {
                    echo '<li class="nav-item ">
