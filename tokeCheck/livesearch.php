<?php 
  ...
  $th=1;
       ...
       <?php while($row=mysqli_fetch_assoc($result)){
        ...
        ?>
          <tr data-href="p_view.php?id=<?php echo $id;?>">
            <td class="align-middle"> <?php echo $th++;?></td>
            <td class="align-middle"> <?php echo $row['pName'];?></td>
            <td class="align-middle"> <?php echo $row['pCode'];?></td>
            <td class="align-middle"> <?php echo $row['pBDate'];?></td>
            <td class="align-middle"> <?php echo $age;?></td>
            ...
            <a href="p_modify.php?id=<?php echo $id;?>" title="Szerkesztés" class="btn btn-outline-warning">
                  <?php include 'img/pencil.svg' ?>
                </a>
                <a href="p_delete.php?id=<?php echo $id;?>" title="Törlés" class="btn btn-outline-danger">
    ...
    else echo "<h3 class='mt-2'>Nem található a megadott paramétereknek megfelelő személy</h3>";
    ?>   
         </tbody>
       </table>
    </div>
